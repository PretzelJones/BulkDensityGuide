...
public class QuoteActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //load hapman quote page
        mWebView.loadUrl("http://hapman.com/request-a-quote");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        /*} else if (id == R.id.nav_quote) {
            ...
            sharingIntent.putExtra(Intent.EXTRA_TEXT, "https://play.google.com/store/apps/details?id=com.seanpattersondesigns.lyte");
            ...
            try {
                ...
                Toast.makeText(QuoteActivity.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
            }
        }
