...
public class AppRater {
    ...
    private static final String DEFAULT_TEXT_TITLE = "Got a second?";
    private static final String DEFAULT_TEXT_EXPLANATION = "Would you be willing to provide us with your thoughts about this app?";
