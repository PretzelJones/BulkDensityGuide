...
public class RepActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //load hapman rep page
        mWebView.loadUrl("http://hapman.com/find-a-hapman-representative");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_about_app) {
            ...
            try {
                ...
                Toast.makeText(RepActivity.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
            }
        }
